<?php
include_once $_SERVER['SRV_DOC_ROOT'] . '/php/klasse/databank/enum/sql_query_type.php';
...
class DATABANK
{
    ...
    private function maak_verbinding() {
        ...
        $databank_config = parse_ini_file( $_SERVER['SRV_DOC_ROOT'] . '/php/configuratie/.databank.ini');
