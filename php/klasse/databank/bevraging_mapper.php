...
include_once $_SERVER['SRV_DOC_ROOT'] . '/php/klasse/databank/vragenlijst_mapper.php';
include_once $_SERVER['SRV_DOC_ROOT'] . '/php/klasse/databank/vraag_mapper.php';
include_once $_SERVER['SRV_DOC_ROOT'] . '/php/klasse/databank/antwoordgroep_mapper.php';
