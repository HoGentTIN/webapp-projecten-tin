...
function download_pdf($html_code, $pdf_naam){
    ...
    $stylesheets = file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/vendor/bootstrap/css/bootstrap.min.css');
    $stylesheets = file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/css/style.css');
